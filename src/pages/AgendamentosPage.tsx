...
import { format, startOfDay, endOfDay } from 'date-fns'; // Removido startOfWeek, endOfWeek, startOfMonth, endOfMonth
...
const AgendamentosPage: React.FC = () => {
  ...
  const [selectedDate, setSelectedDate] = useState<Date>(new Date()); // Mantido para o filtro 'dia'
  ...
  const fetchAppointments = useCallback(async () => {
    ...
    try {
      ...
      // Filter by date for 'dia' tab (using current date)
      if (selectedTab === 'dia') {
        query = query.eq('appointment_date', format(selectedDate, 'yyyy-MM-dd'));
      }
      // TODO: Implement 'semana' and 'mes' filtering logic (currently not implemented)
