...
Write-Host "DEPLOY: finalize-appointment-by-collaborator" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$functionPath = "supabase\functions\finalize-appointment-by-collaborator\index.ts"
